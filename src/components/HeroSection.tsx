      ...
      <div className="max-w-7xl mx-auto px-4 py-12 md:py-20 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-3 items-center gap-8 lg:gap-4">
          ...
          <div className="text-center lg:text-left animate-slideInLeft opacity-0 [animation-delay:0.3s]">
            ...
            <div className="mt-3 flex items-center justify-center lg:justify-start gap-1">
              <CertoLogo size="md" light />
            </div>
            <div className="mt-5 flex items-center justify-center lg:justify-start gap-3">
              <a href="https://apps.apple.com/br/app/clube-vantagens/id1580602045" target="_blank" rel="noopener noreferrer" className="bg-black/30 hover:bg-black/50 transition rounded-lg px-4 py-2.5 flex items-center gap-2 text-sm">
              ...
              <a href="https://play.google.com/store/apps/details?id=br.com.sysmo.b2c.muller" target="_blank" rel="noopener noreferrer" className="bg-black/30 hover:bg-black/50 transition rounded-lg px-4 py-2.5 flex items-center gap-2 text-sm">
          ...
          <div className="text-center lg:text-right animate-slideInRight opacity-0 [animation-delay:0.3s]">
            <p className="text-lg md:text-xl font-medium tracking-widest uppercase opacity-80">Rede</p>
