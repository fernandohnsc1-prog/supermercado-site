      ...
      <div id="nossas-lojas" className="bg-gray-800 py-12">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {lojas.map((loja) => (
              <div key={loja.nome} className="bg-gray-700/50 rounded-2xl p-6 border border-gray-600">
                ...
                <div className="flex gap-3">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 bg-cyan-600 hover:bg-cyan-700 text-white text-sm font-medium px-4 py-2 rounded-xl transition"
                  >
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/#inicio" className="hover:text-orange-400 transition">Início</Link></li>
          ...
          <div>
            ...
            <a
              href="#pesquisa"
              className="inline-block bg-orange-600 hover:bg-orange-700 text-white text-sm font-medium px-4 py-2 rounded-xl transition mt-2"
            >
