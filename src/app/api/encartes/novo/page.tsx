      ...
      <div className="space-y-6">
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-gray-800 border border-gray-700 text-white rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-red-500 transition"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={2}
              className="w-full bg-gray-800 border border-gray-700 text-white rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-red-500 transition resize-none"
            />
          </div>
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6">
          ...
          <div
            ...
            className={`border-2 border-dashed rounded-xl p-8 text-center transition cursor-pointer ${
              arrastando ? 'border-red-500 bg-red-950/20' : 'border-gray-700 hover:border-gray-500'
            }`}
                ...
                <div key={index} className="relative group">
                  <img
                    ...
                    className={`w-full aspect-square object-cover rounded-xl border ${
                      img.erro ? 'border-red-500' : 'border-gray-700'
                    }`}
                  />
                  ...
                  {img.erro && (
                    <div className="absolute inset-0 bg-red-950/80 rounded-xl flex items-center justify-center">
                      <p className="text-red-400 text-xs text-center px-2">Erro no upload</p>
                    </div>
                  )}
                  ...
                  <button
                    ...
                    className="absolute top-1.5 right-1.5 w-6 h-6 bg-red-600 rounded-full text-white text-xs opacity-0 group-hover:opacity-100 transition flex items-center justify-center"
                  >
                    ✕
                  </button>
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            disabled={salvando}
            className="flex-1 bg-red-600 hover:bg-red-500 disabled:bg-red-900 text-white font-semibold rounded-xl py-3 text-sm transition"
          >
